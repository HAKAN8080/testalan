    ...
    if st.session_state.sevkiyat_sonuc is None:
        ...
        with tab2:
            ...
            if st.session_state.magaza_master is not None:
                ...
                magaza_ozet['Mağaza Kod'] = magaza_ozet['Mağaza Kod'].astype(str)
                
                magaza_ozet = magaza_ozet.merge(magaza_detay, left_on='Mağaza Kod', right_on='magaza_kod', how='left')
                magaza_ozet = magaza_ozet.drop('magaza_kod', axis=1)
                
                # Kolon sıralaması
                magaza_ozet = magaza_ozet[['Mağaza Kod', 'magaza_ad', 'il', 'bolge', 
        ...
        # ============================================
        # SATIŞ KAYBI ANALİZİ - DÜZENLENMİŞ
        # ============================================
        with tab3:
...
with tab4:
    ...
    if st.session_state.magaza_master is None:
        ...
        if len(il_bazinda) > 0:
            ...
            # Interaktif harita oluştur - ZOOM SEVİYESİ AYARLANDI
            ...
            if secilen_il:
                ...
                magaza_detay = result_df[result_df['magaza_kod'].isin(
                    magaza_master[magaza_master['il'] == secilen_il]['magaza_kod']
                )]
                ...
                if len(magaza_detay) > 0:
                    ...
                    magaza_ozet = magaza_ozet.merge(
                        st.session_state.magaza_master[['magaza_kod', 'magaza_ad']], 
                        on='magaza_kod', 
                        how='left'
                    )
                    
                    magaza_ozet.columns = ['Mağaza Kodu', 'Toplam Sevkiyat', 'Toplam İhtiyaç', 'Ürün Sayısı', 'Mağaza Adı']
                    magaza_ozet['Gerçekleşme %'] = (magaza_ozet['Toplam Sevkiyat'] / magaza_ozet['Toplam İhtiyaç'] * 100).round(1)
